...
public class CSVFileConstants {
	...
	public static final String CSV_ADDRESS2 = "address2";
	public static final String CSV_ADDRESS3 = "address3";
	public static final String CSV_CITY = "city";
	public static final String CSV_POSTAL_CODE = "postalCode";
